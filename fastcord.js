...
(() => {
  ...
  function getLoaderName() {
    if (isFastcordLoader())
      return fastcordLoaderIdentity.loaderName;
  ...
  function getLoaderVersion() {
    if (isFastcordLoader())
      return fastcordLoaderIdentity.loaderVersion;
    return null;
  }
  ...
  function isSysColorsSupported() {
    if (isFastcordLoader())
      return fastcordLoaderIdentity.isSysColorsSupported;
    else if (isVendettaLoader()) {
  ...
  function isFontSupported() {
    if (isFastcordLoader())
      return fastcordLoaderIdentity.fontPatch === 2;
    return false;
  }
  var fastcordLoaderIdentity, vendettaLoaderIdentity;
  var init_loader = __esm({
    "src/lib/api/native/loader.ts"() {
      "use strict";
      init_asyncIteratorSymbol();
      init_promiseAllSettled();
      fastcordLoaderIdentity = globalThis.__FASTCORD_LOADER__;
      ...
      VdPluginManager = {
        ...
        fetchPlugin(id) {
          ...
          return _async_to_generator(function* () {
            ...
            var pluginManifest;
            try {
              pluginManifest = yield (yield _this.pluginFetch(id + "manifest.json")).json();
            } catch (e) {
            ...
            if (existingPlugin?.manifest.hash !== pluginManifest.hash) {
              try {
                pluginJs = yield (yield _this.pluginFetch(id + (pluginManifest.main || "index.js"))).text();
              } catch (e) {
              }
            }
        ...
        installPlugin(id, enabled = true) {
          ...
          return _async_to_generator(function* () {
            ...
            yield _this.fetchPlugin(id);
            if (enabled)
              yield _this.startPlugin(id);
          })();
        },
        /**
         * @internal
...
//# sourceURL=${plugin.id}`;
        ...
        startPlugin(id) {
          ...
          return _async_to_generator(function* () {
            ...
            try {
              if (!settings.safeMode?.enabled) {
                var pluginRet = yield _this.evalPlugin(plugin);
        ...
        initPlugins() {
          ...
          return _async_to_generator(function* () {
            ...
            if (!settings.safeMode?.enabled) {
              ...
              allIds.filter((pl) => !plugins[pl].enabled && plugins[pl].update).forEach((pl) => _this.fetchPlugin(pl));
            }
  ...
  var _initialState, _revertState, _cache, _client, _retryer, _defaultOptions, _abortSignalConsumed, _dispatch, _class, Query;
  var init_query = __esm({
    "node_modules/@tanstack/query-core/build/modern/query.js"() {
      ...
      init_retryer();
      init_removable();
      Query = (_initialState = /* @__PURE__ */ new WeakMap(), _revertState = /* @__PURE__ */ new WeakMap(), _cache = /* @__PURE__ */ new WeakMap(), _client = /* @__PURE__ */ new WeakMap(), _retryer = /* @__PURE__ */ new WeakMap(), _defaultOptions = /* @__PURE__ */ new WeakMap(), _abortSignalConsumed = /* @__PURE__ */ new WeakMap(), _dispatch = /* @__PURE__ */ new WeakSet(), _class = /* @__PURE__ */ function(Removable2) {
        "use strict";
      ...
      QueryObserver = (_client2 = /* @__PURE__ */ new WeakMap(), _currentQuery = /* @__PURE__ */ new WeakMap(), _currentQueryInitialState = /* @__PURE__ */ new WeakMap(), _currentResult = /* @__PURE__ */ new WeakMap(), _currentResultState = /* @__PURE__ */ new WeakMap(), _currentResultOptions = /* @__PURE__ */ new WeakMap(), _currentThenable = /* @__PURE__ */ new WeakMap(), _selectError = /* @__PURE__ */ new WeakMap(), _selectFn = /* @__PURE__ */ new WeakMap(), _selectResult = /* @__PURE__ */ new WeakMap(), _lastQueryWithDefinedData = /* @__PURE__ */ new WeakMap(), _staleTimeoutId = /* @__PURE__ */ new WeakMap(), _refetchIntervalId = /* @__PURE__ */ new WeakMap(), _currentRefetchInterval = /* @__PURE__ */ new WeakMap(), _trackedProps = /* @__PURE__ */ new WeakMap(), _executeFetch = /* @__PURE__ */ new WeakSet(), _updateStaleTimeout = /* @__PURE__ */ new WeakSet(), _computeRefetchInterval = /* @__PURE__ */ new WeakSet(), _updateRefetchInterval = /* @__PURE__ */ new WeakSet(), _updateTimers = /* @__PURE__ */ new WeakSet(), _clearStaleTimeout = /* @__PURE__ */ new WeakSet(), _clearRefetchInterval = /* @__PURE__ */ new WeakSet(), _updateQuery = /* @__PURE__ */ new WeakSet(), _notify = /* @__PURE__ */ new WeakSet(), _class3 = /* @__PURE__ */ function(Subscribable2) {
        ...
        function _class5(client, options) {
          ...
          if (!_this.options.experimental_prefetchInRender) {
            _class_private_field_get(_this, _currentThenable).reject(new Error("experimental_prefetchInRender feature flag is not enabled"));
          }
          _this.bindMethods();
  ...
  var _client3, _currentResult2, _currentMutation, _mutateOptions, _updateResult, _notify2, _class4, MutationObserver;
  var init_mutationObserver = __esm({
    "node_modules/@tanstack/query-core/build/modern/mutationObserver.js"() {
      ...
      init_subscribable();
      init_utils2();
      MutationObserver = (_client3 = /* @__PURE__ */ new WeakMap(), _currentResult2 = /* @__PURE__ */ new WeakMap(), _currentMutation = /* @__PURE__ */ new WeakMap(), _mutateOptions = /* @__PURE__ */ new WeakMap(), _updateResult = /* @__PURE__ */ new WeakSet(), _notify2 = /* @__PURE__ */ new WeakSet(), _class4 = /* @__PURE__ */ function(Subscribable2) {
        "use strict";
        _inherits(_class5, Subscribable2);
        function _class5(client, options) {
          _class_call_check(this, _class5);
          var _this;
          _this = _call_super(this, _class5), _class_private_method_init(_this, _updateResult), _class_private_method_init(_this, _notify2), _class_private_field_init(_this, _client3, {
            writable: true,
            value: void 0
          ...
          _class_private_field_set(_this, _client3, client);
          _this.setOptions(options);
          _this.bindMethods();
        ...
        _create_class(_class5, [
          ...
          },
          {
            ...
            value: function setOptions(options) {
              var prevOptions = this.options;
              this.options = _class_private_field_get(this, _client3).defaultMutationOptions(options);
              if (!shallowEqualObjects(this.options, prevOptions)) {
                _class_private_field_get(this, _client3).getMutationCache().notify({
                  type: "observerOptionsUpdated",
          ...
          },
          {
            ...
            value: function mutate(variables, options) {
              ...
              _class_private_field_get(this, _currentMutation)?.removeObserver(this);
              _class_private_field_set(this, _currentMutation, _class_private_field_get(this, _client3).getMutationCache().build(_class_private_field_get(this, _client3), this.options));
  ...
  function useBaseQuery(options, Observer, queryClient2) {
    ...
    React7.useSyncExternalStore(React7.useCallback((onStoreChange) => {
      var unsubscribe = shouldSubscribe ? observer.subscribe(notifyManager.batchCalls(onStoreChange)) : noop2;
  ...
  function initializeFastcord() {
    return _initializeFastcord.apply(this, arguments);
  }
  function _initializeFastcord() {
    _initializeFastcord = _async_to_generator(function* () {
      try {
